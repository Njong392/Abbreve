            ...
            <section className="block justify-center pb-16 md:flex">
                ...
                <div className="md:w-1/2 md:pr-20 md:text-left text-center">
                    <form className="block md:flex items-center gap-3" id="form">
                        <div className="w-full relative marker:bg-ash h-11 rounded-full flex items-center p-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-6 h-6 text-purple absolute left-5">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                            </svg>

                            <input type="text" placeholder="Search slang full meaning..." className="w-full flex-1 indent-10 h-11 rounded-full border-none outline-none text-gray text-lg bg-ash" value={userInput} onChange={(e) => setUserInput(e.target.value)} />
                        </div>
